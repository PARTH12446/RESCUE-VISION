import { DisasterPrediction, DisasterType, SeverityLevel } from '@/types/disaster';
import { 
  CloudRain, 
  Flame, 
  Mountain, 
...
const disasterIcons: Record<DisasterType, typeof CloudRain> = {
  earthquake: Mountain,
  flood: CloudRain,
  hurricane: Wind,
  wildfire: Flame,
...
export function DisasterCard({ prediction }: DisasterCardProps) {
  const Icon = disasterIcons[prediction.type];
  
  return (
    <div className={cn(
      "glass rounded-xl p-5 hover:border-primary/50 transition-all duration-300",
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-foreground capitalize">{prediction.type}</h3>
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm font-semibold text-foreground">{prediction.riskScore}/10</span>
        </div>
