      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="space-y-4">
          <div className="glass rounded-xl p-4">
            <h3 className="font-semibold text-foreground mb-3">Active Threats</h3>
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className={`text-xs px-2 py-0.5 rounded-full ${
                      prediction.severity === 'critical' ? 'bg-destructive/20 text-destructive' :
                  ...
                  <p className="text-xs text-primary mt-1">{(prediction.probability * 100).toFixed(0)}% probability</p>
                </div>
              ))}
            </div>
          </div>
